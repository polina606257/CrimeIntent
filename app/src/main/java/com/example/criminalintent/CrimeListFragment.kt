    ...
    private inner class CrimeHolder(view: View) : RecyclerView.ViewHolder(view), View.OnClickListener {
        ...
        fun bind(crime: Crime) {
            ...
            solvedImageView.visibility = if (crime.isSolved) {
                ...
                solvedImageView.contentDescription = getString(R.string.crime_report_unsolved)
                View.GONE
            }
        }
        ...
        override fun onClick(v: View?) {
            ...
            // findNavController().navigate(CrimeListFragmentDirections.actionCrimeListFragmentToCrimeFragment(crime.id.toString()))
        }
    }
